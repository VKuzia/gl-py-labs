...
from lab4.core.camera import MovingCamera
from lab4.core.model.model import Model
from lab4.core.scene import Scene
...
class Window(mglw.WindowConfig):
    ...
    def __init__(self, **kwargs):
        ...
        self.scene = Scene(self.load_program("shaders.glsl"), self.aspect_ratio, (0, 0, -5))
